...
import { createRawStreamRPCPlugin, createSerializationAdapter, executeRewriteInput, invariant, isNotFound, isRedirect as isRedirect$1, isResolvedRedirect, resolveManifestAssetLink, rootRouteId } from "@tanstack/router-core";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-Bz1zgi-w.js");
